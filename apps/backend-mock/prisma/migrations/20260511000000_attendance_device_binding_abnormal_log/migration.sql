CREATE TABLE IF NOT EXISTS `attendance_device_binding` (
  ...
  `device_token_hash` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '设备绑定凭证哈希，后端不保存明文凭证',
...
CREATE TABLE IF NOT EXISTS `attendance_device_abnormal_log` (
  ...
  `abnormal_type` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '异常类型：device_changed更换设备，device_credential_mismatch设备凭证异常，same_device_multi_account同设备多账号，多个类型用逗号分隔',
